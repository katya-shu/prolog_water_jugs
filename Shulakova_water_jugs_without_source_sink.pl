...
% Операції переливання між ємностями
...
% Перевірка наявності потрібної кількості рідини в одній із ємностей
has_goal_amount(State, GoalAmount) :-
